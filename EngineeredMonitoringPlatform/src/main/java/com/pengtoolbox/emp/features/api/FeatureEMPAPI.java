...
public class FeatureEMPAPI extends CFWAppFeature {
	...
	public static final String RESOURCE_PACKAGE = "com.pengtoolbox.emp.features.api.resources";
	public static final String MANUAL_PACKAGE = "com.pengtoolbox.emp.features.api.manual";
