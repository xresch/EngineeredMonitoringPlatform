...
public class WidgetHostMetricsStatus extends WidgetDefinition {
	 ...
	 ************************************************************/
	@Override
	public String getWidgetType() {return FeatureDynatrace.WIDGET_PREFIX + "_hostmetricsstatus";}
	 ...
	 ************************************************************/
	@Override
	public String widgetName() { return "Host Metric Status"; }
	...
	public void fetchData(HttpServletRequest request, JSONResponse response, CFWObject settings, JsonObject jsonSettings, CFWTimeframe timeframe) { 
		...
		if(environment == null) {
			CFW.Messages.addWarningMessage("Dynatace Host Metrics Status: The chosen environment seems not configured correctly.");
			return;
		}
