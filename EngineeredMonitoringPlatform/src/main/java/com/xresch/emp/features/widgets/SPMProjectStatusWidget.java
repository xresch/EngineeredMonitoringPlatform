...
public class SPMProjectStatusWidget extends WidgetDefinition {
	...
	private static Logger logger = CFWLog.getLogger(SPMProjectStatusWidget.class.getName());
	@Override
	...
	public ArrayList<FileDefinition> getJavascriptFiles() {
		...
		FileDefinition js = new FileDefinition(HandlingType.JAR_RESOURCE, FeatureEMPWidgets.RESOURCE_PACKAGE, "emp_widget_spmprojectstatus.js");
		array.add(js);
		return array;
	}
