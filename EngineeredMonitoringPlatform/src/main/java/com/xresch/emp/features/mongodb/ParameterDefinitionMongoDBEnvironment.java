...
public class ParameterDefinitionMongoDBEnvironment extends ParameterDefinition {
	...
	public String descriptionShort() {
		return "Parameter that allows a user to select a MongoDB environment he has access too.";
	}
	...
	public String descriptionHTML() {
		return CFW.Files.readPackageResource(FeatureMongoDB.PACKAGE_MANUAL, "parameter_"+LABEL.toLowerCase().replace(" ", "_")+".html");
	}
