...
public class WidgetHostEvents extends WidgetDefinition {
	...
	public void createSampleData(JSONResponse response) { 
		...
		response.getContent().append(CFW.Files.readPackageResource(FeatureDynatraceManaged.PACKAGE_RESOURCE, "emp_widget_dynatrace_hostevents_sample.json") );
	...
	public ArrayList<FileDefinition> getJavascriptFiles() {
		...
		array.add( new FileDefinition(HandlingType.JAR_RESOURCE, FeatureDynatraceManaged.PACKAGE_RESOURCE, "emp_widget_dynatrace_hostevents.js") );
		return array;
	}
