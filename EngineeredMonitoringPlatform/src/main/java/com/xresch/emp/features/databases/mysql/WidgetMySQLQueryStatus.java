...
public class WidgetMySQLQueryStatus extends WidgetDefinition {
	...
	public CFWObject getSettings() {
		return new CFWObject()
				...
				.addField(CFWField.newString(FormFieldType.TEXT, FIELDNAME_URLCOLUMN)
						.setLabel("{!emp_widget_mysqlquerystatus_urlcolumn!}")
						.setDescription("{!emp_widget_mysqlquerystatus_urlcolumn_desc!}")
				)
	...
	public JsonArray loadDataFromMySQL(CFWObject widgetSettings){
		...
		//---------------------------------
		// Get Environment
		String environmentID = (String)widgetSettings.getField(MySQLSettingsFactory.FIELDNAME_ENVIRONMENT).getValue();
