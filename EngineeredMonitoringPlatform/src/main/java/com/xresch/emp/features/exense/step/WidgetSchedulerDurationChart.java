...
public class WidgetSchedulerDurationChart extends WidgetDefinition  {
	 ...
	 ************************************************************/
	@Override
	public String getWidgetType() {return FeatureExenseStep.WIDGET_PREFIX+"_schedulerdurationchart";}
	...
	public ArrayList<FileDefinition> getJavascriptFiles() {
		...
		array.add( new FileDefinition(HandlingType.JAR_RESOURCE, FeatureExenseStep.PACKAGE_RESOURCE, "emp_widget_step_schedulerdurationchart.js") );
		return array;
	}
