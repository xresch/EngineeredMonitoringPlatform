...
public class StepEnvironment extends AbstractContextSettings {
	...
	public StepEnvironment dbHost(String value) {
	...
	public StepEnvironment dbPort(int value) {
	...
	public StepEnvironment dbName(String value) {
	...
	public StepEnvironment dbUser(String value) {
	...
	public StepEnvironment dbPassword(String value) {
	...
	public StepEnvironment timezone(String value) {
