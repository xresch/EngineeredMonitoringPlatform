...
public class ParameterDefinitionStepEnvironment extends ParameterDefinition {
	...
	public static final String LABEL = "Step Environment MongoDB";
	...
	public String descriptionHTML() {
		return CFW.Files.readPackageResource(FeatureExenseStepMongoDB.PACKAGE_RESOURCE, "parameter_"+LABEL.toLowerCase().replace(" ", "_")+".html");
	}
	/***************************************************************
	 * 
	 ***************************************************************/
