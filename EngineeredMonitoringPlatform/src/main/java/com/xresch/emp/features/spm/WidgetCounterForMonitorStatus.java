...
public class WidgetCounterForMonitorStatus extends WidgetDefinition {
	 ...
	 ************************************************************/
	@Override
	public String widgetName() { return "Counter For Monitor Status"; }
	...
	public void fetchData(HttpServletRequest request, JSONResponse response, CFWObject settings, JsonObject jsonSettings, CFWTimeframe timeframe) { 
		...
		for(Entry<String, JsonElement> entry : countersObject.entrySet()) {
			...
			ResultSet result = db.preparedExecuteQuerySilent(
					CFW.Files.readPackageResource(FeatureSPM.PACKAGE_RESOURCE, "emp_widget_spmcounterformonitorstatus.sql"),
					monitorID,
					measureName);
	...
	public ArrayList<FileDefinition> getJavascriptFiles() {
		...
		array.add( new FileDefinition(HandlingType.JAR_RESOURCE, FeatureSPM.PACKAGE_RESOURCE,  "emp_widget_spmcounterformonitorstatus.js") );
		return array;
	}
