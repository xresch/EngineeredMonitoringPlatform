...
public class CFWJobTaskPlanStatusByUser extends CFWJobTask {
	
	private WidgetPlanStatusByUser widget = new WidgetPlanStatusByUser();

	@Override
	public String uniqueName() {
		return "Alerting: Step Plan Status by User";
	}
