...
public class CFWJobTaskSchedulerStatus extends CFWJobTask {
	
	private WidgetSchedulerStatus widget = new WidgetSchedulerStatus();

	@Override
	public String uniqueName() {
		return "Alerting: Step Scheduler Status";
	}
